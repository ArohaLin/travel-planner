...
import { BrochureShareButton } from '@/components/brochure/BrochureShareButton'
    ...
    >
      <div className="px-4 py-3 flex items-center gap-3">
        ...
        <div className="flex gap-1 flex-shrink-0">
          {/* 宣傳冊：所有看得到行程的成員都能檢視；只有 owner/admin 能管理 */}
          <BrochureShareButton itineraryId={itineraryId} canManage={role === 'owner'} />
