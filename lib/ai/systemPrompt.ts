    ...
    days: itinerary.days.map((d) => {
      ...
      return {
        ...
        activities: rest.activities.map((a) => {
          const { photoRef, userPhotoUrl, bookingPlatform, orderNumber, bookingReference, depositPaid, freeCancelBy, contact, ...act } = a
          void photoRef; void userPhotoUrl; void bookingPlatform; void orderNumber; void bookingReference; void depositPaid; void freeCancelBy; void contact
          return act
        }),
